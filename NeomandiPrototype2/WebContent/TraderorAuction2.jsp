...
%>	<div class="one">
	...
	<tbody>
		<tr>
			<td><%if(tlb.getRigid().equals("y")){ %>
				<button type="button" data-toggle="tooltip" title="Click here to change status" data-placement=top onclick="rigid()" class="btn btn-info " id="rigid" style="width:110px;text-align: center;"><div id="rg">RIGID </div></button><br><br><%} else{ %>
				<button type="button" data-toggle="tooltip" title="Click here to change status" data-placement=top  onclick="rigid()" class="btn btn-success" id="rigid" style="width:110px; text-align: center;"><div id="rg">FLEXIBLE </div></button><br><br><%} %>
	...
	{ 
	    ...
	    if (this.readyState == 4 && this.status == 200) 
	    {
		     ...
		     {
			    document.getElementById("rg").textContent=" FLEXIBLE";
			    document.getElementById("rigid").className ="btn btn-success"
		     }
	    	 else if(string.includes('n'))
	    	 {
	    		document.getElementById("rg").textContent="RIGID";
